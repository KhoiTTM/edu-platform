...
export function HeroMomentumCard({ streak, totalMinutes }: HeroMomentumCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-[2.5rem] border-4 border-[#201625] bg-gradient-to-br from-[#2e1c3b] via-[#1a0f26] to-[#0e0717] p-8 shadow-[0_15px_0_#150b1a,0_25px_50px_rgba(0,0,0,0.6)] transition-all duration-300">
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="relative flex h-20 w-20 items-center justify-center rounded-[1.8rem] bg-gradient-to-tr from-purple-500 via-indigo-600 to-pink-500 border-4 border-purple-200 shadow-[0_6px_0_#3b0764,0_10px_20px_rgba(168,85,247,0.3)]">
            <span className="text-3xl filter drop-shadow-md select-none">{getRankBadge()}</span>
            {/* Glossy shine */}
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-2xl font-black text-white tracking-tight leading-none uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
              {getTitle()}
            </h2>
            <div className="flex items-center gap-1.5 text-slate-400 text-xs font-semibold">
              <Trophy size={14} className="text-yellow-400" />
              <span>Tiếp tục học để thăng cấp tiếp theo!</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4 sm:gap-6">
          {/* Streak Card */}
          <div className="flex items-center gap-4 bg-slate-950/60 border-2 border-purple-950/50 rounded-3xl p-4 shadow-inner min-w-[140px]">
            ...
            <div>
              ...
              <p className="text-xl font-black text-white">{streak} Ngày</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-slate-950/60 border-2 border-purple-950/50 rounded-3xl p-4 shadow-inner min-w-[140px]">
            ...
            <div>
              ...
              <p className="text-xl font-black text-white">{totalMinutes} Phút</p>
            </div>
          </div>
        </div>
