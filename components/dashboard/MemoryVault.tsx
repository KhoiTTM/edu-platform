      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {moments.map((moment, idx) => (
          <div 
            ...
            className="group relative p-6 rounded-3xl bg-slate-800/30 border border-slate-700/50 hover:bg-slate-800/50 hover:border-amber-500/30 transition-all duration-300"
          >
