...
import { Trophy, ChevronRight, Share2, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-3xl text-center space-y-1">
      ...
      {bestMoment && (
        <div className="p-8 bg-gradient-to-br from-sky-900/40 to-indigo-950/40 border border-sky-500/30 rounded-3xl space-y-4 relative overflow-hidden group">
          ...
          <div className="space-y-1">
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-sky-400">Your Best Moment</h4>
          ...
          <div className="flex justify-between items-center pt-2">
            ...
            <button className="text-xs font-bold text-sky-400 hover:text-sky-300 transition flex items-center gap-1">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        ...
        {sessionNumber < 4 && (
          <Link
            href={`/speaking/unit-1/session-${sessionNumber + 1}`}
