...
export function AssessmentResultCard({ score, correctCount, totalCount, onContinue }: AssessmentResultCardProps) {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-8 bg-surface-raised rounded-3xl shadow-2xl flex flex-col items-center border border-line">
      ...
      <div className="w-full mb-8">
        <h3 className="text-lg font-bold text-slate-300 mb-4">Chi tiết bài làm</h3>
        <div className="flex flex-col gap-3">
          <div className="flex justify-between items-center p-4 bg-surface/50 border border-line/50 rounded-xl">
      ...
      <button
        onClick={onContinue}
        className="w-full py-4 bg-sky-600 text-white font-bold rounded-xl shadow-[0_6px_0_rgb(2,132,199)] active:translate-y-[6px] active:shadow-none hover:bg-sky-500 transition-all text-lg tracking-wide"
      >
        Tiếp tục
      </button>
    </div>
