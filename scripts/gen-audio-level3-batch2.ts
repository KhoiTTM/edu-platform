...
async function main() {
  const jsonPath = path.join('content', 'exam-bank', 'pre-a1-listening-level3-batch2-source.json');
  ...
  console.log(`Bat dau sinh audio batch 2 bang ELEVENLABS_API_KEY_SECOND. Tong cau nguon: ${data.dialogues.length}`);
