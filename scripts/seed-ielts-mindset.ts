...
const pingPassage = `Ping gets up at 7.30am every morning and has breakfast with his host family. At 8.30am, he catches the bus to his language school. During the day, Ping studies English and chats to his classmates. Everyone speaks English in his class because the students all come from different countries around the world. After Ping finishes school at 3:00pm, he often does some sightseeing in the city with his friends. In the evening, Ping relaxes with his host family, watches TV or goes online.`;

const danPassage = `Dan usually gets up at 8am, has a shower and eats breakfast. After that, he always gets his books ready and then goes to his lectures until midday. He usually returns home and makes lunch for himself at about 12:30pm. Then, he sometimes watches a bit of TV. At about 3pm, he often meets a friend for coffee. At 3.30pm, they sometimes go to the library together. Dan always studies for a few hours and then at around 6.30pm he goes home. He usually cooks dinner for himself and his flat mates. In the evening, he sometimes exercises at the gym or goes for a run. After that, he relaxes in front of the TV or sees his friends. He never goes to bed early, but usually falls asleep at around midnight.`;

const harryPassage = `Hi Sam, I'm having a great time here in France. My host family are very nice. They live in an apartment in an area called Pantin, and both work as journalists. They wake up very early in the morning and leave the house before me. I have breakfast at about 8am and then go to the language school. I usually walk there, but if I'm late I catch the bus. Lessons at the school finish at 4pm and we can go home. We meet after school in a cafe or go out in the evenings to the cinema.`;

const williamPassage = `I have a new job! It's in a supermarket and I work there every Saturday. I start at 8am and the shop opens at 9am. I fill the shelves with food products and tidy the shopping baskets by the entrance. I clean the floors and work at the checkout. My manager is very nice. She tells me what to do and never shouts. The other workers are really friendly, too. We take three breaks a day and finish at 4pm. It's hard work because the shop gets very busy, but I really enjoy it.`;

const allQuestions = [
  // --- PAGE 12 ---
  { type: "inline_fill_blank", instruction: "Read the sentences about a boy who is doing a language course in the UK. Choose the best answer.", reading_passage: pingPassage, text_segments: ["At 8.30am, he ", " the bus to his language school."], correct_answers: ["catches"], word_pool: ["goes", "catches", "travels"] },
  { type: "inline_fill_blank", instruction: "Choose the best answer.", reading_passage: pingPassage, text_segments: ["During the day, Ping studies English and ", " to his classmates."], correct_answers: ["chats"], word_pool: ["laughs", "chats", "tells"] },
  { type: "inline_fill_blank", instruction: "Choose the best answer.", reading_passage: pingPassage, text_segments: ["Everyone speaks English in his class because the students all ", " from different countries around the world."], correct_answers: ["come"], word_pool: ["arrive", "come", "live"] },
  { type: "inline_fill_blank", instruction: "Choose the best answer.", reading_passage: pingPassage, text_segments: ["After Ping finishes school at 3:00pm, he often ", " some sightseeing in the city with his friends."], correct_answers: ["does"], word_pool: ["does", "makes", "has"] },
  { type: "inline_fill_blank", instruction: "Choose the best answer.", reading_passage: pingPassage, text_segments: ["In the evening, Ping relaxes with his host family, ", " TV or goes online."], correct_answers: ["watches"], word_pool: ["watches", "sees", "looks"] },
  ...
  // --- PAGE 15 ---
  { type: "inline_fill_blank", instruction: "Complete the text using the verbs in brackets in the correct form.", reading_passage: danPassage, text_segments: ["Dan usually ", "(get up) at 8am, ", "(have) a shower and ", "(eat) breakfast. After that, he always ", "(get) his books ready and then ", "(go) to his lectures until midday. He usually ", "(return) home and ", "(make) lunch for himself at about 12:30pm."], correct_answers: ["gets up", "has", "eats", "gets", "goes", "returns", "makes"], word_pool: ["gets up", "get ups", "has", "haves", "eats", "eat", "gets", "goes", "go", "returns", "makes"] },
  { type: "inline_fill_blank", instruction: "Complete the text using the verbs in brackets in the correct form. (Part 2)", reading_passage: danPassage, text_segments: ["Then, he sometimes ", "(watch) a bit of TV. At about 3pm, he often ", "(meet) a friend for coffee. At 3.30pm, they sometimes ", "(go) to the library together. Dan always ", "(study) for a few hours and then at around 6.30pm he ", "(go) home."], correct_answers: ["watches", "meets", "go", "studies", "goes"], word_pool: ["watches", "watch", "meets", "meet", "go", "goes", "studies", "studys"] },
  { type: "inline_fill_blank", instruction: "Complete the text using the verbs in brackets in the correct form. (Part 3)", reading_passage: danPassage, text_segments: ["He usually ", "(cook) dinner for himself and his flat mates. In the evening, he sometimes ", "(exercise) at the gym or goes for a run. After that, he relaxes in front of the TV or ", "(see) his friends. He never goes to bed early, but usually ", "(fall) asleep at around midnight."], correct_answers: ["cooks", "exercises", "sees", "falls"], word_pool: ["cooks", "exercises", "sees", "falls", "cook", "exercise", "see", "fall"] },
  ...
  { type: "inline_fill_blank", instruction: "Complete the email using the words in the box.", reading_passage: williamPassage, text_segments: ["I have a new job! It's in a supermarket and I ", " there every Saturday. I ", " at 8am and the shop ", " at 9am. I ", " the shelves with food products and ", " the shopping baskets by the entrance."], correct_answers: ["work", "start", "opens", "fill", "tidy"], word_pool: ["work", "start", "opens", "fill", "tidy"] },
  { type: "inline_fill_blank", instruction: "Complete the email using the words in the box. (Part 2)", reading_passage: williamPassage, text_segments: ["I ", " the floors and ", " at the checkout. My manager is very nice. She ", " me what to do and never ", ". The other workers are really friendly, too."], correct_answers: ["clean", "work", "tells", "shouts"], word_pool: ["clean", "work", "tells", "shouts"] },
  { type: "inline_fill_blank", instruction: "Complete the email using the words in the box. (Part 3)", reading_passage: williamPassage, text_segments: ["We ", " three breaks a day and ", " at 4pm. It's hard work because the shop ", " very busy, but I really ", " it."], correct_answers: ["take", "finish", "gets", "enjoy"], word_pool: ["take", "finish", "gets", "enjoy"] }
];
