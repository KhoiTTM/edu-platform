...
async function seed() {
  console.log("Starting unified static seeding for Vietnamese 3 Theme 1-4...");

  const filesToProcess = [
    { file: 'chu_diem_1_exams.json', slug: 'chu_diem_1', unitNum: 1 },
    { file: 'chu_diem_2_exams.json', slug: 'chu_diem_2', unitNum: 2 },
    { file: 'chu_diem_3_exams.json', slug: 'chu_diem_3', unitNum: 3 },
    { file: 'chu_diem_4_exams.json', slug: 'chu_diem_4', unitNum: 4 }
  ];
  ...
  for (const item of filesToProcess) {
    ...
    for (const examData of data.exams) {
      ...
      // Create Collection
      // IMPORTANT: Set volume and units to correctly group them on UI
      let colData: any = {
      ...
      // Fallback if unit_id column doesn't exist
  ...
  console.log("Seeding complete for Theme 1-4!");
}
