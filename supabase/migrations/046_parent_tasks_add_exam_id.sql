-- Migration 046: Add optional specific exam selection for parent tasks
ALTER TABLE public.parent_tasks ADD COLUMN IF NOT EXISTS exam_id UUID REFERENCES public.exams(id) ON DELETE SET NULL;

-- Update generate_daily_tasks_for_student RPC to use the specific exam if set
